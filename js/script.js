  ...
  if (status && action) {
      ...
      switch (action) {
          ...
          case 'no-login-message':
              ...
              break;
          case 'add_membership':
              message = (status === 'success') ? 'Adding package successful!' : 'Failed to add package!';
              break; 
          ...
          case 'Membershipbooking':
                message = (status === 'success') ? 'Booking Successfully our staff member will contact you soon.' : 'failed to Booking Package!';
                break;
          ...
          case 'add_program':
                message = (status === 'success') ? 'program added successfully!.' : 'failed to add program!';
                break;

          case 'delete_program':
                message = (status === 'success') ? 'program deleted successfully!.' : 'failed to delete program!';
                break;

          case 'add_trainer':
                message = (status === 'success') ? 'Trainer added successfully!.' : 'failed to add trainer!';
                break;
    
               
          case 'update_trainer':
                message = (status === 'success') ? 'Trainer updated successfully!.' : 'failed to update trainer!';
                break; 

          case 'delete_trainer':
                message = (status === 'success') ? 'Trainer deleted successfully!.' : 'failed to delete trainer!';
                break;     


          case 'add_trainerprogram':
                message = (status === 'success') ? 'Training program added successfully!.' : 'failed to add Training program r!';
                    break;  
                
          case 'update_program':
                message = (status === 'success') ? 'Training program updated successfully!.' : 'failed to update Training program r!';
                break;  
          ...
          case 'programBooking':
                message = (status === 'success') ? 'programBooking succeffully! Our one of team member will contact you soon.have a wondaful day!' : 'failed to book program!';
                break;
