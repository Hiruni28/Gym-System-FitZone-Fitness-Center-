...
<section class="details-container">
    <div class="details-header">
        ...
        <div class="details-info">
            ...
            if (isset($_SESSION['customer_id'])) {
                ...
                echo '<a href="programBoking.php?category=' . urlencode($category_title) . '&program=' . urlencode($title) . '" class="book-btn">Book</a>';
            } else {
    ...
    <div class="details-content">
        <h3 style="color: orangered;">Class Details Description</h3>
        <p><?php echo htmlspecialchars($description); ?></p>

        <h3 style="color: orangered;">Features</h3>
        <ul>
        ...
        <h3 style="color: orangered;">Dates and Time Schedule</h3>
        <ul>
        ...
        <a href="programs.php" class="back-button">Back to Classes</a>
    </div>
</section>
