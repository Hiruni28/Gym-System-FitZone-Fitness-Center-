...
<div class="main-content">
    <div class="wrapper">
        <h1 class="text-center">Available Nutrition Programs</h1>
        ...
        <form action="" method="POST" class="dropdown-form">
            <select name="file-select" class="styled-select" onchange="location = this.value;">
                ...
                <option value="manage-classProgram.php">Manage Classes</option>
                <option value="manage-training.php">Manage Training</option>
                <option value="manage-nutration.php" selected>Manage Nutrition</option>
            </select>
        </form>
        ...
        <a href="add-program.php" class="btn-primary">Add Nutrition Program</a>
        <br><br>

        <div class="programs-grid">
            <?php
            // Fetch nutrition programs from tbl_programs
            $sql = "SELECT * FROM tbl_programs WHERE category_id = (SELECT id FROM tbl_programCategories WHERE title = 'Nutrition Counselling')";
            $res = $conn->query($sql);
...
<p><span class="label">Price (Foreign):</span> $<?php echo htmlspecialchars($price_foreign); ?></p>
                        ...
                        <div class="program-actions">
                            <a href="update-nutrition.php?id=<?php echo $program_id; ?>" class="btn-secondary">Update</a>
