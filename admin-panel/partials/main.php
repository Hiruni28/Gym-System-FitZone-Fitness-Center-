...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="logo" style="color:plum;">FitZone Fitness Center</div>
    ...
    <div class="container">
        ...
        <div class="sidebar">
            ...
            <ul>
                ...
                <li><a href="manage-categoryProgram.php">Programs Categories</a></li>
                <li><a href="manage-classProgram.php">Programs</a></li>
                ...
                <li><a href="manage-persontrainer.php">Trainer Details</a></li>
