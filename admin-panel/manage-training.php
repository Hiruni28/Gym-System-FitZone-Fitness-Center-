...
<div class="main-content">
    <div class="wrapper">
        <h1 class="text-center">Available Training Programs</h1>
        ...
        <form action="" method="POST" class="dropdown-form">
            <select name="file-select" class="styled-select" onchange="location = this.value;">
                ...
                <option value="manage-training.php" selected>Manage Training</option>
        ...
        <a href="add-training.php" class="btn-primary">Add Training Program</a>
        <br><br>
        ...
        <div class="programs-grid">
            ...
            $sql = "SELECT p.id, p.title, p.price_local, p.price_foreign, p.schedule, p.features, p.image_name, p.active, t.name AS trainer_name 
                    ...
                    WHERE p.category_id = (SELECT id FROM tbl_programCategories WHERE title = 'Personalized training programs')";
            ...
            ?>
                    ...
                    <div class="program-box">
                        ...
                        <div class="program-details">
                            ...
                            <p><span class="label">Trainer:</span> <?php echo htmlspecialchars($trainer_name); ?></p>
