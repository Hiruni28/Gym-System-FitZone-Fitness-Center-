...
<div class="main-content">
    <div class="wrapper">
        <h1 class="text-center">Programs Bookings</h1>
        ...
        <form action="" method="POST" class="dropdown-form">
            <select name="file-select" class="styled-select" onchange="location = this.value;">
                ...
                <option value="manage-bookinPackage.php">Program Bookings</option>
                <option value="manage-bookinProgram.php">Membership Bookings</option>
            </select>
        </form>
